...
public class CameraControllerScript : MonoBehaviour
{
    ...
    private Vector3 m_cameraDiffPos;

    public float maxAngle = 80;
    public float minAngle = 0;

    private float m_cameraDiffAngle;
    ...
    void Start()
    {
        ...
        cameraRailPosition = m_cameraRailStartPosition;

        m_cameraDiffPos = highestPosition - lowestPosition;
        m_cameraDiffAngle = maxAngle - minAngle;
